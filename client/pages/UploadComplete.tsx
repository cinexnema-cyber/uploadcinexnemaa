    ...
    return (
      <div className="min-h-screen grid place-items-center text-white">
        <div className="max-w-md text-center space-y-3">
          <h1 className="text-3xl font-extrabold">Upload Completo</h1>
          <p className="text-white/70 text-sm">
            Faça login para acessar o formulário completo.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              updateFormData("tituloAlternativo", e.target.value)
            }
        ...
        <div>
          ...
          >
            ...
            <option className="text-black" value="Curta">
              Curta
            </option>
            <option className="text-black" value="Documentário">
              Documentário
            </option>
          </select>
        </div>
        ...
        <div>
          ...
          <select
            ...
            required
          >
            <option className="text-black" value="Livre">
              Livre
            </option>
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              updateFormData("anoLancamento", parseInt(e.target.value))
            }
            min="1900"
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              updateFormData("duracao", parseInt(e.target.value))
            }
            placeholder="Ex: 120"
            className="bg-transparent border-white/20 text-white"
            required
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              updateFormData("legendasDisponiveis", e.target.value)
            }
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium mb-2">
            Capa principal (poster) *
          </label>
          <div className="text-xs text-white/60 mb-2">
            JPG/PNG, mínimo 600x900px
          </div>
          <Input
            type="file"
            accept="image/jpeg,image/png"
            onChange={(e) =>
              updateFormData("capaFile", e.target.files?.[0] || null)
            }
            className="bg-transparent border-white/20 text-white"
            required
          />
        ...
        <div>
          ...
          <div className="text-xs text-white/60 mb-2">
            JPG/PNG, mínimo 320x180px
          </div>
          <Input
            type="file"
            accept="image/jpeg,image/png"
            onChange={(e) =>
              updateFormData("thumbnailFile", e.target.files?.[0] || null)
            }
            className="bg-transparent border-white/20 text-white"
            required
          />
        ...
        <div>
          ...
          <div className="text-xs text-white/60 mb-2">
            JPG/PNG, mínimo 1280x720px
          </div>
          <Input
            type="file"
            accept="image/jpeg,image/png"
            onChange={(e) =>
              updateFormData("bannerFile", e.target.files?.[0] || null)
            }
            className="bg-transparent border-white/20 text-white"
          />
        </div>
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="text-xs text-white/60 mb-2">
          MP4, resolução mínima 720p
        </div>
        <Input
          type="file"
          accept="video/mp4"
          onChange={(e) =>
            updateFormData("videoFile", e.target.files?.[0] || null)
          }
          className="bg-transparent border-white/20 text-white"
          required
        />
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              updateFormData("framerate", parseInt(e.target.value))
            }
            placeholder="Ex: 24"
            className="bg-transparent border-white/20 text-white"
          />
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              updateFormData("bitrate", parseInt(e.target.value))
            }
            placeholder="Ex: 2500"
            className="bg-transparent border-white/20 text-white"
          />
  ...
  const renderStep4 = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium mb-2">
            Direitos autorais / distribuidor *
          </label>
          <Input
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-transparent border border-white/20 text-white rounded-md p-3"
          >
            <option className="text-black" value="Gratuito">
              Gratuito
            </option>
            <option className="text-black" value="Assinante">
              Assinante
            </option>
            <option className="text-black" value="Pago">
              Pago
            </option>
            <option className="text-black" value="Aluguel">
              Aluguel
            </option>
          </select>
        </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              updateFormData("restricaoGeografica", e.target.value)
            }
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-white/70">
                Formulário detalhado para upload de conteúdo
              </p>
            </div>
            <Button
              variant="outline"
